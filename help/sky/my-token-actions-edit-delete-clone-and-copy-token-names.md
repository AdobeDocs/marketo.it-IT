...
1. Fare clic con il pulsante destro del mouse sul token, quindi selezionare **[!UICONTROL Delete]**.
...
1. Per duplicare un token personale, fate clic con il pulsante destro del mouse su di esso e selezionate **[!UICONTROL Clone]**.
