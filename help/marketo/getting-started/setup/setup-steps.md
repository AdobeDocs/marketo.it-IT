...
**Benvenuta al Marketo Engage!**

Prima di iniziare a utilizzare Marketo, devi completare alcuni passaggi.

Questi passaggi includono:

* Configurazione di base dell&#39;account
* Personalizzazione degli URL della pagina di destinazione e dei collegamenti e-mail per migliorare l’affidabilità e il recapito messaggi
...
>[!TIP]
>
>Una data di scadenza è ottima per i soggetti esterni a breve termine o per i consulenti che necessitano solo dell&#39;accesso Marketo per un breve periodo.

>[!NOTE]
>
>Quando arriva la data di scadenza, l’utente riceve una notifica di scadenza e l’account è bloccato.
...
Scorri verso il basso fino a branding Domains (Domini di branding). Seleziona il dominio e fai clic su **Modifica**.
