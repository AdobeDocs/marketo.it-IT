...
>[!TIP]
>
>Se [stampa questo elenco di controllo](/help/marketo/getting-started/initial-setup/setup-checklist.md){target="_blank"}, è possibile disattivare gli elementi mentre vengono completati.
