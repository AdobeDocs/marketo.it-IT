...
<tbody>
  ...
  <tr>
    ...
    <li>Valuta la creazione <a href="https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/reporting/basic-reporting/report-activity/clone-a-report-to-group-reports" target="_blank">rapporti core clonabili</a> ci si aspetta che ogni unità aziendale utilizzi il massimo per ridurre il tempo necessario per estrarre il rapporto e garantire la correttezza dei dati. Vedi i dettagli nella sezione <a href="#global-reports">Tabella dei report globali di seguito</a>.
...
<tbody>
  <tr>
    ...
    <p><img src="assets/tip-icon.png" alt="icona nota"> SUGGERIMENTO: le e-mail dell’abbonamento vengono solitamente inviate di notte. Se desideri che le persone accedano ai dati del rapporto in tempo reale, devi aggiungere le persone come utenti, in modo che possano controllare direttamente il rapporto.
    <p>
