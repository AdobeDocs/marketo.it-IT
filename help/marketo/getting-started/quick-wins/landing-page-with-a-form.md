...
1. In **Nuovo**, fare clic su **Nuovo programma**.
...
1. Fate clic sulle frecce per scorrere i temi. Selezionatene uno.
...
1. Fate clic su **Approva e chiudi**.
   ...
   Super! Ora avete un programma con un modulo all&#39;interno. Passiamo ora alla creazione di una pagina.
...
1. Una volta aperto l’editor della pagina di destinazione, trascinate l’elemento Modulo nell’area di lavoro.
...
1. Tutte le modifiche vengono salvate automaticamente. Chiudere la scheda o la finestra dell&#39;editor moduli.
...
1. Selezionate la pagina di destinazione, in Azioni **pagina di** destinazione fate clic su **Approva**.
   ...
   Perfetto! Vedete il segno di spunta verde?
...
1. Cercare l&#39;indirizzo e-mail univoco utilizzato durante la compilazione del modulo.
   ...
   Eccolo! È stata creata una nuova pagina di destinazione contenente un modulo e utilizzata per generare una nuova persona.
