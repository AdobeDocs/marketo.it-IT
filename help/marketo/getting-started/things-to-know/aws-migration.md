...
Le nuove date e le informazioni relative al centro dati/pod vengono aggiunte o modificate periodicamente, pertanto è necessario monitorare questa pianificazione per eventuali aggiornamenti. Non è possibile rinunciare o richiedere di spostare la migrazione a una data diversa.

Se per qualche motivo una migrazione non ha esito positivo, riceverai una notifica e la pianificazione verrà riprogrammata.
...
Per informazioni aggiornate, aggiungi un segnalibro a questa pagina. Per ricevere gli aggiornamenti sullo stato all&#39;inizio e al completamento della migrazione, [abbonati](https://experienceleague.adobe.com/it/docs/marketo/using/getting-started/things-to-know/system-status-notifications){target="_blank"} per riceverli. Durante la finestra di migrazione, puoi anche visitare il sito https://status.adobe.com/it-it/.
...
**A chi appartiene l&#39;ambiente di storage?**
