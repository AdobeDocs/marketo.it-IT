---
description: Note sulla nuova versione - Documentazione di Marketo - Documentazione del prodotto
title: Note sulla nuova versione
hide: true
hidefromtoc: true
...
Sono disponibili due miglioramenti per la personalizzazione in tempo reale di Marketo Engage.

* **Aggiornamento a Google Analytics 4**: gli utenti RTP disporranno di un tag alfanumerico univoco (situato nel `<head>` sezione dell’html) nelle rispettive pagine di destinazione, che consente a Marketo di inviare dati alle Google Analytics. Marketo ha già utilizzato Universal Analytics, che interromperà la registrazione dei dati entro il 1° luglio 2023. Per completare la migrazione, gli utenti RTP dovranno seguire la procedura di migrazione nel dashboard Google Analytics.

* **Aggiornamento a jQuery 3.7**: per migliorare la sicurezza e la stabilità, Marketo sta effettuando l’aggiornamento a jQuery 3.7.0. Gli utenti RTP che caricano jQuery autonomamente possono essere influenzati negativamente se utilizzano una versione precedente alla 3.0.0. Questi utenti possono contattare il supporto Marketo per assistenza nell’implementazione di una versione specifica di rtp.js in base alle loro esigenze. Se utilizzi la versione 3.0.0 o successiva, non sei interessato da questo problema.
