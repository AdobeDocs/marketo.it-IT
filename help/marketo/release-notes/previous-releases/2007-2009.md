...
* **Enhanced****Geo-location**: sono stati raccolti ulteriori dati dedotti per aiutarti a identificare i lead, inclusi città, stato/regione, codice postale, prefisso telefonico e area metropolitana dedotti.
...
* **Dettagli lead**: layout personale. Sapete come la finestra a comparsa dei dettagli del lead contiene molti e tanti campi? Beh, abbiamo sentito la necessità di mettere un layout della dashboard sulla casa e lasciare che si scelga quali campi andare lì. Fai clic su Amministratore in alto a destra, quindi su Layout dettagli lead. È tutto tramite trascinamento, quindi dovrebbe essere facile da creare.
...
* **Notizie sulle prestazioni**: miglioramento della velocità del 75% per tutti gli alberi! Questo dovrebbe rendere molto più veloce lo spostamento all’interno dell’applicazione. Sono disponibili ulteriori miglioramenti al tocco per la velocità. Non ci riposeremo finché non sarà un fulmine veloce.
