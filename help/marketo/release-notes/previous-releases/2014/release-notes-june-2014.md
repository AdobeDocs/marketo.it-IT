...
Crea, leggi e aggiorna i lead a livello di programmazione tramite la nuova API ReST. Per iniziare a utilizzare ReST è necessario [creare un servizio personalizzato](/help/marketo/product-docs/administration/additional-integrations/create-a-custom-service-for-use-with-rest-api.md) in Marketo. Poi vai al [sito per sviluppatori](https://experienceleague.adobe.com/en/docs/marketo-developer/marketo/rest/rest-api/) per informazioni dettagliate sull’utilizzo di questa API.

## Aggiornamento della pagina delle campagne Marketo Real-Time Personalization (RTP) {#marketo-real-time-personalization-rtp-campaigns-page-update}

Le campagne RTP ora includono un nuovo design con visualizzazioni di miniature e prestazioni della campagna. Inoltre, è possibile [organizzare le campagne](/help/marketo/product-docs/web-personalization/working-with-web-campaigns/sort-web-campaigns-by-latest-or-top-performing.md) in base alla data o alle prestazioni migliori.
...
L’integrazione con [Google Analytics](/help/marketo/product-docs/web-personalization/reporting-for-web-personalization/web-analytics-integrations/integrate-rtp-with-google-analytics.md) (GA) è ora abilitato per impostazione predefinita, quindi in Impostazioni account attiva l’interruttore per il quale desideri inviare i dati alle variabili ed eventi personalizzati GA.
