...
## App di check-in evento tablet Android {#android-tablet-event-check-in-app}

Controlla gli utenti registrati nel tuo evento utilizzando il nostro nuovo [App di check-in basata su Android](/help/marketo/product-docs/core-marketo-concepts/mobile-apps/event-check-in/check-people-into-your-event-from-your-tablet.md) disponibile su [Google Play](https://play.google.com/store/apps/details?id=com.marketo.eventcheckin&amp;hl=en).
