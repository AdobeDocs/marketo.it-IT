...
<table style="border: 0px">
 <tbody> 
  ...
  <tr> 
   <td><strong>Scheda Azione nel flusso Designer</strong>: gli addetti al marketing possono utilizzare le schede Azioni nel flusso Finestra di dialogo per passare valori nascosti al record persona del Marketo Engage quando i visitatori interagiscono con una finestra di dialogo.</td> 
   <td>Spedito</td>
  ...
  <tr> 
   ...
   <td> </td>
    ...
    <tr> 
   <td><strong>Targeting elenchi smart di Marketo Engage</strong>: gli addetti al marketing possono eseguire il targeting dei membri degli elenchi smart di Marketo Engage nei criteri di pubblico di Dialog.</td> 
   <td>Spedito</td>
  ...
  <tr> 
   ...
   <td> </td>
    ...
    <tr> 
   <td><strong>Token di attivazione per nuove attività</strong>: sono disponibili nuovi token di attivazione per supportare le nuove attività per il Dynamic Chat.</td> 
   <td>Spedito</td>
  ...
  <tr> 
   ...
   <td> </td>
    ...
    <tr> 
   <td><strong>Pagina risorse flusso conversazionale</strong>: la pagina delle risorse di Design Studio elenca ora i flussi conversazionali di Dynamic Chat. Scopri quali flussi possono essere integrati nelle risorse di Marketo Engage e collegati direttamente al loro editor.</td> 
   <td>Spedito</td>
   <td>n/d</td>
  </tr>
  <tr> 
   ...
   <td> </td>
    ...
    <tr> 
   <td><strong>Notifiche azioni di approfondimento vendite</strong>: gli agenti con azioni di approfondimento vendite riceveranno in tempo reale notifiche di richiesta di chat dal vivo nel pannello Azioni di approfondimento vendite.</td> 
   <td><i>In arrivo</i></td>
   <td><i>In arrivo</i></td>
  </tr>
 </tbody> 
...
* **Marketo Events e Marketo Moments Deprecation**: a partire dal 2 ottobre 2023, Adobe rimuoverà Marketo Events e Marketo Moments da tutti gli app store. Utenti esistenti: puoi continuare a utilizzare queste app fino a quando non esegui la migrazione dell’istanza di Marketo Engage a Adobe Identity. Queste app non supportano l’accesso con Adobe ID.

* **Disattivazione interruttore per Design Studio Assets**: lo switch di attivazione che consente agli utenti di passare dall&#39;interfaccia classica all&#39;esperienza UX moderna per Design Studio diventerà obsoleto insieme alla versione precedente dell&#39;esperienza Design Studio, consentendo agli utenti di migrare completamente all&#39;esperienza UX moderna. [Ulteriori informazioni](https://nation.marketo.com/t5/the-next-generation-experience/adobe-marketo-engage-switch-to-modern-experience-for-all-design/ba-p/339411){target="_blank"}.
