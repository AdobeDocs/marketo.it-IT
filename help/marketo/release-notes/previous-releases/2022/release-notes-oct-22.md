...
* **Sincronizzazione campi personalizzati membri del programma**: possibilità di sincronizzare in modo bidirezionale i campi estensibili acquisiti per un membro del programma (ad esempio, le preferenze dei partecipanti durante la registrazione dell&#39;evento, ad esempio cibo, sessioni, brani e così via) con i campi membri della campagna in Salesforce.
