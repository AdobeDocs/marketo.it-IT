...
* **Programma per Salesforce Campaign Sincronizzazione**: sincronizza i programmi Marketo con le campagne Salesforce, inclusi i membri, lo stato e i costi.
...
* **Condivisione social delle pagine di destinazione**: aggiungi e configura facilmente i pulsanti di condivisione social nelle e-mail, inclusi Facebook, Twitter, LinkedIn e Google+.
* **Supporto nativo per l&#39;opportunità**: particolarmente utile per i clienti che non utilizzano Salesforce come CRM, è stato rilasciato un set di nuove API per eseguire operazioni di creazione, lettura, aggiornamento ed eliminazione (CRUD) sull&#39;oggetto Opportunity in Marketo.
...
* **Personalizza stelle e fiamme**: ora puoi scegliere i campi di punteggio che guidano le stelle e le fiamme in Sales Insight.
...
* **Scheda WebEx**: connettere facilmente un evento avanzato a un evento WebEx (richiesto Centro eventi WebEx) e utilizzare le pagine di destinazione e i moduli di Marketo per acquisire i partecipanti e registrarli automaticamente in WebEx.
...
* **Analizzatore di programmi**: con una semplice occhiata è possibile confrontare facilmente diversi canali (ad esempio webinar, fiere commerciali, posizionamenti di annunci, ecc.) e valutare quali sono i fattori che stanno guidando i rendimenti migliori in un&#39;ampia selezione di misurazioni di successo.
...
* **Rapporto sulle violazioni SLA**: questo rapporto mostra il numero di volte in cui la soglia di tempo SLA è stata violata in un determinato periodo di tempo.
...
* **Aggiornamento approfondimenti vendite**: miglioramenti delle prestazioni e invio di un massimo di 200 e-mail alla volta.
...
* **Token campagna Salesforce**: assegnazione dinamica dei lead alle campagne Salesforce.
* **Integrazione chat per Sales Insight**: ora includiamo i momenti di interesse nella timeline della chat.
* **Regole di assegnazione della partizione lead**: semplifica l&#39;assegnazione della partizione per i nuovi lead Salesforce e API
