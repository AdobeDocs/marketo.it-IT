...
<table style="table-layout:auto">
 ...
 <tr>
  ...
  <tr>
   ...
   <td>Beta aperta</td>
   <td><a href="https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/coworker-for-marketo/overview" target="_blank">Panoramica di Marketo AI</a></td>
  </tr>
  <tr>
   <td> </td>
   <td> </td>
