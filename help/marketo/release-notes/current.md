...
* **Filtro** avanzato: Diverse API ora supportano più filtri, ad esempio l’aggiunta di un filtro per l’intervallo di date alle risorse e ai campi dei membri del programma per e-mail.
