...
Le seguenti funzionalità sono incluse nella release di maggio. Per informazioni sulla disponibilità delle funzionalità, controllare il [Marketo](http://docs.marketo.com/display/docs/assets/pricing.php) [Edition](http://docs.marketo.com/display/docs/assets/pricing.php).
