...
Dopo questa configurazione iniziale, controlla [Best practice per una nuova istanza di Marketo Engage](/help/marketo/temp-getting-started-section/temp-best-practice-checklists/where-to-start.md) sezione per trarre il massimo dall’investimento e prepararsi per il successo a lungo termine.
