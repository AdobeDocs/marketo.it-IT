...
<tbody>
  <tr>
    ...
    <td><li>Raccogliere un elenco di origini dati da cui verranno estratti i record <a href="https://experienceleague.adobe.com/en/docs/marketo/using/getting-started-with-marketo/quick-wins/import-a-list-of-people" target="_blank">importa nel Marketo Engage</a>.</li>
