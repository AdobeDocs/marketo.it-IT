...
+ [Home](home.md)
+ Introduzione al Marketo Engage {#getting-started}
   ...
   + Generazione della domanda {#demand-generation}
      ...
      + Dynamic Chat {#dynamic-chat}
         ...
         + Chat automatizzata {#automated-chat}
            ...
            + [Temp. Stream Designer](product-docs/demand-generation/dynamic-chat/automated-chat/stream-designer-temp.md)
         ...
         + Chat live {#live-chat}
            ...
            + [Temp casella in entrata agente](product-docs/demand-generation/dynamic-chat/live-chat/agent-inbox-temp.md)
