...
* `Include an image` nelle e-mail (come un logo), il destinatario è incoraggiato a consentire la visualizzazione del messaggio da parte delle immagini.

* `Include a link` come chiamata all&#39;azione nell&#39;e-mail.
