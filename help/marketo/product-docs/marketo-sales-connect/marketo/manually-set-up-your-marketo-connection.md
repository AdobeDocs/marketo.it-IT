---
description: Impostare manualmente la connessione Marketo - Documentazione Marketo - Documentazione del prodotto
title: Configurazione manuale della connessione Marketo
...
# Impostare manualmente la connessione Marketo {#manually-set-up-your-marketo-connection}

>[!NOTE]
>
>Quando esegui il provisioning di MSC, Marketo invierà automaticamente le tue credenziali a Sales Connect e collegherà la tua istanza a Marketo. Questo passaggio è obbligatorio **solo** se non viene visualizzata la connessione stabilita dopo il provisioning dell&#39;istanza Sales Connect. Se la connessione è stata stabilita, le credenziali verranno visualizzate nella pagina Impostazioni amministratore di Marketo.
