...
description: Comprendere come funziona la registrazione delle risposte quando Sales Connect è connesso a Salesforce. Ottieni aiuto nella configurazione della posizione in cui sono registrate le risposte in Salesforce.
