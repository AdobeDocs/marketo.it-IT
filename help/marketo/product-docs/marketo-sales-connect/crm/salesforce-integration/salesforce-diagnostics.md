...
description: Informazioni sulla diagnostica di Salesforce per Sales Connect. Risolvere i problemi di connessione e sincronizzazione tra Sales Connect e Salesforce.
...
**Passaggi per la risoluzione dei problemi:** L&#39;amministratore [!DNL Salesforce] dovrà inserire nell&#39;elenco Consentiti i nostri IPs. Gli utenti devono contattare il supporto tecnico per ottenere gli indirizzi IP.
