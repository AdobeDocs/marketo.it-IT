...
description: Ottieni aiuto quando l'attività di tracciamento di Sales Connect non viene visualizzata in Salesforce. Risoluzione dei problemi relativi al motivo per cui le e-mail o le chiamate potrebbero non accedere a Salesforce.
