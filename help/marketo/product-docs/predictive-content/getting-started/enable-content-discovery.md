...
Se si imposta l&#39;opzione Rilevamento contenuto su Attivato, verrà automaticamente rilevato un contenuto PDF o video quando un visitatore Web fa clic sul file o guarda il video. Questo contenuto (URL, nome contenuto e URL immagine) viene aggiunto e quindi tracciato nella pagina Tutto il contenuto. Quando scopriamo automaticamente il video, scopriamo un video quando un visitatore Web fa clic e guarda un video incorporato da YouTube, Vimeo o Wistia. Per scoprire automaticamente altri contenuti, è necessario [creare pattern di contenuto](create-content-patterns.md).
