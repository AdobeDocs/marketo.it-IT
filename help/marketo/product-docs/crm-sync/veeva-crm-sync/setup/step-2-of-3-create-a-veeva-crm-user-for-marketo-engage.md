---
description: Scopri come creare un utente Veeva CRM per la sincronizzazione Marketo Engage. Impostare i layout di pagina, creare l'utente di sincronizzazione e assegnare le autorizzazioni per gli aggiornamenti dei campi.
