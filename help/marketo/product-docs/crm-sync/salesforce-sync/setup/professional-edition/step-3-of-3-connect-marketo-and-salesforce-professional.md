...
1. Nella barra di ricerca di navigazione, digita &quot;reset&quot; e fai clic su **[!UICONTROL Reimposta il token di sicurezza]**.
...
1. In Marketo, vai a **[!UICONTROL Amministratore]**, seleziona **[!UICONTROL CRM]** e fai clic su **[!UICONTROL Sincronizza con Salesforce.com]**.
...
1. Immetti le credenziali utente di sincronizzazione Salesforce create nella parte 2 della configurazione Salesforce ([Professionale](/help/marketo/product-docs/crm-sync/salesforce-sync/setup/professional-edition/step-2-of-3-create-a-salesforce-user-for-marketo-professional.md), [Enterprise](/help/marketo/product-docs/crm-sync/salesforce-sync/setup/enterprise-unlimited-edition/step-2-of-3-create-a-salesforce-user-for-marketo-enterprise-unlimited.md)) e fai clic su **[!UICONTROL Sincronizza campi]**.
   ...
   >[!NOTE]
   >
   >Verifica **[!UICONTROL Sandbox]** se stai sincronizzando una Sandbox Marketo in una Sandbox Salesforce.
