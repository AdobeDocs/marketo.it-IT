...
# Passaggio 1 di 3: Aggiungi campi Marketo a Salesforce (Enterprise/Unlimited) {#step-of-add-marketo-fields-to-salesforce-enterprise-unlimited}

>[!PREREQUISITES]
>
>Devi avere accesso alle API Salesforce per la sincronizzazione tra Marketo e Salesforce.
