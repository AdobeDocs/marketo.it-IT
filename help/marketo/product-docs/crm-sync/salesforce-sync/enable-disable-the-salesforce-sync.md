...
description: Scopri come abilitare o disabilitare la sincronizzazione di Salesforce in Marketo. Disattiva la sincronizzazione in Admin quando effettui modifiche principali al campo o alla sincronizzazione, quindi riattiva quando è pronto.
