---
description: Scopri il dashboard Stato di sincronizzazione di Salesforce e come visualizzare le statistiche di sincronizzazione. Filtrare per data, tipo di operazione o tipo di oggetto ed esportare gli errori di sincronizzazione come CSV.
...
1. In [!UICONTROL Integration], fare clic su **Salesforce**, quindi sulla scheda **[!UICONTROL Sync Status]**.
...
1. Seleziona l&#39;intervallo di date e ora, quindi fai clic sull&#39;elenco a discesa per filtrare in base a [!UICONTROL Object Type], [!UICONTROL Operation Type] e/o [!UICONTROL Status Type].
...
<table>
 ...
 <tbody>
  ...
  <tr>
   ...
   <td colspan="1">Aggiornamenti o nuovi record in SFDC sincronizzati con Marketo; Pull Events as Activities (Eventi pull come attività)</td>
