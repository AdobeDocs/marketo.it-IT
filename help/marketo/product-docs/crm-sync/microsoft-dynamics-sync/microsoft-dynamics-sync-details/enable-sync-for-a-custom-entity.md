...
description: Scopri come abilitare la sincronizzazione per un’entità personalizzata in Microsoft Dynamics e Marketo. Utilizza Admin e Microsoft Dynamics per selezionare e abilitare le entità personalizzate per la sincronizzazione.
...
Se hai bisogno che i dati di entità personalizzati di [!DNL Dynamics] siano disponibili in Marketo Engage, segui i passaggi seguenti.
...
1. Seleziona **[!UICONTROL Microsoft Dynamics]** e fai clic su **[!UICONTROL Disable Sync]**.
