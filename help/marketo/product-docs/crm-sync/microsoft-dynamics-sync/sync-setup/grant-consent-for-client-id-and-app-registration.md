...
1. Utilizzare un programma di testo pulito (Blocco note per Windows, Modifica testo per Mac) per creare un URI (Uniform Resource Identifier) per l&#39;autorizzazione incollando il testo seguente e sostituendo i valori client_id, redirect_uri e status.
...
1. Fai clic sul pulsante **Concedere il consenso dell’amministratore** (per tenant).
