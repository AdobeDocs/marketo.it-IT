...
1. Inserisci il **[!UICONTROL Nome utente]**, **[!UICONTROL Password]** a Microsoft Dynamics **[!UICONTROL URL]**, e un **ID client/segreto**. Clic **[!UICONTROL Salva]** al termine.
   ...
   >[!TIP]
   >
   >Non conosci l’URL? Ti mostreremo come trovare il tuo [URL servizio organizzazione Dynamics](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/view-the-organization-service-url.md){target="_blank"} qui.
