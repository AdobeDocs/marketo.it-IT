...
>[!CAUTION]
>
>Se per Dynamics Sync è abilitato Multi-Factor Authentication (MFA), è necessario disattivarlo per consentire la corretta sincronizzazione di Dynamics con Marketo. Per ulteriori informazioni, contattare [Supporto Marketo](https://nation.marketo.com/t5/Support/ct-p/Support){target="_blank"}.
...
1. Fai clic su **[!UICONTROL Amministratore]** e quindi la scheda **[!DNL Microsoft Dynamics]** nell’area Integrazione.
...
1. Fai clic su **[!UICONTROL Convalida impostazione sincronizzazione]** scheda.

   ![](assets/image2015-9-28-16-3a11-3a45.png)

1. Inserisci il nome utente, la password e l’URL (l’ID client e il segreto client sono facoltativi). Clic **[!UICONTROL Successivo]** al termine.

   ![](assets/four-1.png)

   >[!NOTE]
   >
   >Se hai già eseguito la sincronizzazione, **[!UICONTROL CRM]** nell’albero a sinistra verrà letto **[!DNL Microsoft Dynamics]** e i dati nel modulo di cui sopra possono essere precompilati.
...
>[!MORELIKETHIS]
>
>[Correggi i problemi di sincronizzazione della convalida Dynamics](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/validate-microsoft-dynamics-sync/fix-dynamics-validation-sync-issues.md){target="_blank"}
