...
>* [Installazione di Marketo per Microsoft Dynamics 2016/Dynamics 365 on-premises Passaggio 2 di 3](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-2016-dynamics-365-on-premises/step-2-of-3-set-up.md){target="_blank"}
...
1. Inserisci il **[!UICONTROL Nome utente]**, **[!UICONTROL Password]** a Microsoft Dynamics **[!UICONTROL URL]**, e un **ID client/segreto**. Clic **[!UICONTROL Salva]** al termine.
