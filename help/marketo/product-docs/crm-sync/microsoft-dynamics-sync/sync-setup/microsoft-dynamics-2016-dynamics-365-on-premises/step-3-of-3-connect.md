...
>[!PREREQUISITES]
>
>* [Installa Marketo per Microsoft Dynamics 2016/Dynamics 365 locale Passaggio 1 di 3](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-2016-dynamics-365-on-premises/step-1-of-3-install.md){target="_blank"}
>* [Installa Marketo per Microsoft Dynamics 2016/Dynamics 365 locale Passaggio 2 di 3](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-2016-dynamics-365-on-premises/step-2-of-3-set-up.md){target="_blank"}
...
1. Fai clic su **[!UICONTROL Modifica]** in **[!UICONTROL Inserisci credenziali]**.
...
1. Immetti **[!UICONTROL Nome utente]**, **[!UICONTROL Password]**, **[!UICONTROL URL]** di Microsoft Dynamics e **ID/segreto client**. Al termine, fai clic su **[!UICONTROL Salva]**.
   ...
   >[!TIP]
   >
   >Non conosci l’URL? Qui verrà illustrato come trovare l&#39;[URL del servizio Dynamics Organization](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/view-the-organization-service-url.md).

## Seleziona campi da sincronizzare {#select-fields-to-sync}

1. Fai clic su **[!UICONTROL Modifica]** in **[!UICONTROL Seleziona campi da sincronizzare]**.
...
1. Fai clic su **[!UICONTROL Modifica]** in **[!UICONTROL Abilita sincronizzazione]**.
...
1. Leggi tutto il contenuto del popup, immetti il tuo indirizzo e-mail e fai clic su **[!UICONTROL Avvia sincronizzazione]**.
