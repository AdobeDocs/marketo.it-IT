...
1. Clic **[!UICONTROL Aggiungi e concedi licenze agli utenti]** nella nuova finestra.

   ![](assets/five.png)

1. Viene visualizzata una nuova scheda. Clic **[!UICONTROL Amministratore]** nella parte superiore della pagina.

   ![](assets/six.png)

1. Viene visualizzata un’altra nuova scheda. Clic **[!UICONTROL Aggiungi un utente]**.
...
1. Immetti l’e-mail per ricevere le nuove credenziali utente e fai clic su **[!UICONTROL Invia e-mail e chiudi]**.
...
1. Torna a **[!UICONTROL Utenti abilitati]** e aggiorna l’elenco degli utenti.
...
1. Clic **[!UICONTROL Gestisci ruoli]**.
...
1. Torna alla sezione Impostazioni avanzate e fai clic su ![](assets/image2015-5-13-15-3a49-3a19.png) accanto a Impostazioni e selezionare **[!UICONTROL Configurazione Marketo]**.

   ![](assets/fourteen.png)

   >[!NOTE]
   >
   >Se non vedi **[!UICONTROL Configurazione Marketo]** nel menu Settings (Impostazioni), aggiorna la pagina. Se non funziona, prova a [pubblicare la soluzione Marketo](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-365-with-ropc-connection/step-1-of-4-install.md){target="_blank"} oppure esci e accedi di nuovo.

1. Clic **[!UICONTROL Predefinito]**.

   ![](assets/fifteen.png)

1. Fare clic sul pulsante di ricerca nella **[!UICONTROL Utente Marketo]** e selezionare l&#39;utente di sincronizzazione creato.
...
1. Fai clic su ![](assets/image2015-5-13-15-3a49-3a19-1.png) accanto a Impostazioni e selezionare **[!UICONTROL Soluzioni]**.

   ![](assets/eighteen.png)

1. Fai clic su **[!UICONTROL Pubblica tutte le personalizzazioni]** pulsante.

   ![](assets/nineteen.png)

>[!MORELIKETHIS]
>
>[Passaggio 3 di 4: connettere la soluzione Marketo con la connessione di controllo della password del proprietario della risorsa](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-365-with-ropc-connection/step-3-of-4-set-up.md){target="_blank"}
