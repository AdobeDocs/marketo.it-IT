...
1. Immetti **[!UICONTROL Nome utente]**, **[!UICONTROL Password]**, Microsoft Dynamics **URL**, **[!UICONTROL ID client]** e **[!UICONTROL Segreto client]**. Al termine, fai clic su **[!UICONTROL Salva]**.
