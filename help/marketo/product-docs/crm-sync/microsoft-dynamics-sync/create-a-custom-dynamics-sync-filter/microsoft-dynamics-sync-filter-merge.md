...
description: Comprendere il funzionamento del filtro di sincronizzazione Dynamics durante l’unione dei lead. Scopri in che modo il valore del filtro di sincronizzazione dei record vincente determina se il record viene sincronizzato con Marketo.
