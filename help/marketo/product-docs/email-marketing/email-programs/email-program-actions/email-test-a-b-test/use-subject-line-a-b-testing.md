...
Puoi testare facilmente le e-mail tramite test A/B. Uno dei test più comuni è il test **Subject Line**.
...
1. Utilizza il cursore per scegliere la percentuale del pubblico che desideri ricevere il test A/B e fai clic su **Avanti**.
