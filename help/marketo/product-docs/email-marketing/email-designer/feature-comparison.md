...
description: Scopri le differenze tra le funzioni di Email Editor 2.0 e del nuovo Email Designer. Utilizza la tabella per confrontare la disponibilità delle funzionalità.
...
<tbody>
  ...
  <tr>
    ...
    <td>Possibilità di <a href="/help/marketo/product-docs/email-marketing/email-designer/import-template.md" target="_blank">importare modelli di Marketo esistenti</a> nel nuovo Designer di posta elettronica.</td>
  ...
  <tr>
    <td>Temi del brand</td>
    <td>Possibilità di <a href="/help/marketo/product-docs/email-marketing/email-designer/brands/brand-themes.md" target="_blank">applicare i temi approvati</a> in tutta l'organizzazione per garantire la coerenza di elementi quali stile, colore, dimensione del carattere e così via.</td>
    <td>Non disponibile</td>
    <td>Disponibile</td>
  </tr>
  <tr>
