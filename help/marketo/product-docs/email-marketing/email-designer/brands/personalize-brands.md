...
product: Marketo
title: Personalizzazione dei marchi
...
Utilizza la scheda **[!UICONTROL About the brand]** per stabilire l&#39;identità principale del tuo marchio, delineandone lo scopo, la personalità, la tagline e altri attributi di definizione.
...
Ora puoi personalizzare ulteriormente il tuo marchio o [pubblicare il tuo marchio](/help/marketo/product-docs/email-marketing/email-designer/brands/manage-brands.md#create-brand-kit).
