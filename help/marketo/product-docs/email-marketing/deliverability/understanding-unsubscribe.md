...
description: Scopri i tipi di annullamento dell’abbonamento in Marketo (Annulla abbonamento, Marketing Sospeso,). Utilizza il campo corretto per ogni scenario nelle campagne.
