...
description: Scopri i tipi di annullamento dell’abbonamento in Marketo Inserire nell'elenco Bloccati (Annulla abbonamento, Marketing Sospeso,). Utilizza il campo corretto per ogni scenario nelle campagne.
