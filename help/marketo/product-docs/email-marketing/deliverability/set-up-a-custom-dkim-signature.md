...
description: Scopri come impostare una firma DKIM personalizzata per il dominio in Marketo. Aggiungi un dominio in Admin e collabora con l’IT per pubblicare il record DNS.
