...
description: Scopri i token di sistema disponibili nelle e-mail di Marketo. Utilizza il glossario per trovare il token corretto per la personalizzazione.
