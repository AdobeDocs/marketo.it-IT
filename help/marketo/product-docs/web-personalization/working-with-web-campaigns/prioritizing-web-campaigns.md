...
1. Nella pagina Modifica campagna, imposta il punteggio di priorità (9999 = Priorità più alta 1 = Priorità più bassa).
   ...
   >[!TIP]
   >
   >È consigliabile utilizzare il Punteggio di priorità della campagna solo in caso di potenziale sovrapposizione di campagne, con una maggiore importanza di una delle campagne. Non è necessario impostare una priorità per ogni campagna.

1. Salva o avvia la campagna.

1. Consulta il Punteggio di priorità visualizzato nella pagina Campagne web.
