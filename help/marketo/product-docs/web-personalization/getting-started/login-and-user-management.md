...
1. Immettere un [!UICONTROL Role Name] e selezionare [!UICONTROL Permissions]. Fare clic su **[!UICONTROL Create]** (questo ruolo deve [essere applicato a tutte le aree di lavoro](/help/marketo/product-docs/administration/users-and-roles/edit-user-workspaces.md)).
