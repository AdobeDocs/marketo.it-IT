...
Creare e generare campagne e-mail

Le sezioni contrassegnate [PER KEITH:] richiedono la compilazione di altro contenuto specifico per il prodotto.\
I segnaposto per le schermate utilizzano [SCREENSHOT: description] — estrarre le schermate già nella bozza di origine o acquisirne di nuove dall&#39;ambiente di prova.

Inoltre, Keith, ho usato &#39;Halo&#39; come segnaposto, ma questo nome cambierà in base alla decisione della leadership.

Forma

[FOR KEITH: 1-2 frase introduttiva che crea fiducia e orienta il lettore. Framing suggerito: &quot;Entro la fine di questa guida, avrai creato e rivisto la tua prima campagna e-mail completa in Halo. Inizia a finire, ci vuole circa [TEMPO STIMATO].&quot;]
...
Un account Halo attivo (registrati qui se non lo hai ancora fatto).

Il brand è configurato in &quot;La tua roba > Marchi&quot;. (Ulteriori informazioni)

(Facoltativo ma consigliato) Un modello e-mail di HTML caricato in Your stuff > Email templates.

Un CSV di pubblico pronto per il caricamento. Se hai bisogno di un punto di partenza, scarica un file CSV di esempio per il pubblico.
...
Nozioni di base del prompt

Scrittura di obiettivi efficaci
...
Scegli un modello di campagna preconfezionato dalla sezione modelli sotto la barra dei prompt.

Utilizza l’opzione &quot;help me prompt&quot; (Richiedi aiuto) dal menu a discesa nella barra dei prompt per fare in modo che Halo ti guidi attraverso la scrittura del prompt.
...
Un forte messaggio Halo include:

L&#39;obiettivo della campagna — quello che state cercando di raggiungere.

Il pubblico — a chi appartiene o da dove provengono i dati del pubblico.

Il formato e la struttura — numero di e-mail, cadenza, tono.
...
Premi Genera campagna. Halo:

Generare un piano di campagna strutturato
...
Costruire il percorso in modo dinamico lungo il percorso
...
Qui è dove l&#39;interfaccia conversazionale di Halo guadagna la sua tenuta. Per apportare modifiche, rivolgiti a Halo:
...
Avvia la campagna. (Attualmente non disponibile con il rilascio, ma verrà abilitato entro 2 settimane dalla prima versione, in attesa dell’autorizzazione legale)

Esporta singole e-mail come HTML.

Esporta l’intera campagna come documento Word o PDF per la revisione del team.

[PER KEITH: Dettagli su ciascuna opzione ed eventuali controlli pre-avvio eseguiti da Halo (conformità, collegamenti interrotti, campi di personalizzazione mancanti, ecc.).]
...
Casi d’uso della nostra raccolta: sfoglia esempi di prompt reali per eseguire il remix delle tue campagne.

Introduzione a Halo — Torna alla panoramica.

Prompting Halo — best practice (disponibile a breve)
