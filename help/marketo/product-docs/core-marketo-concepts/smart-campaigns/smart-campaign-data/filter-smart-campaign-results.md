...
1. Nella scheda **[!UICONTROL Results]** di Smart Campaign, fai clic su **[!UICONTROL Filter]** e seleziona un filtro salvato.
...
1. Fare clic su **[!UICONTROL Filter]**, quindi su **[!UICONTROL Custom]**.

   ![](assets/filter-smart-campaign-results-2.png)

1. Selezionare i tipi di attività da visualizzare e fare clic su **[!UICONTROL Save As]**.

   ![](assets/filter-smart-campaign-results-3.png)

   >[!TIP]
   >
   >Fai clic su **[!UICONTROL Apply]** per applicare direttamente un filtro personalizzato ai risultati senza salvarlo.

1. Immettere un nome di filtro e fare clic su **[!UICONTROL Save]**.
