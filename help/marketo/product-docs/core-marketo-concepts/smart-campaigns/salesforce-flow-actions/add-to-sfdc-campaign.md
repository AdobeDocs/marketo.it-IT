...
1. Trova e seleziona la campagna Salesforce a cui desideri aggiungere i lead.
   ...
   >[!TIP]
   >
   >Puoi utilizzare la campagna Salesforce [Miei token](/help/marketo/product-docs/core-marketo-concepts/programs/tokens/managing-my-tokens.md) per semplificare la duplicazione dei programmi.
...
1. Selezionare lo stato del membro della campagna Salesforce che si desidera assegnare ai lead quando vengono aggiunti.
   ...
   >[!CAUTION]
   >
   >Se una persona è già un membro principale della campagna Salesforce, verrà saltata e il suo stato NON verrà aggiornato. È invece possibile utilizzare [per modificarne lo stato in una campagna SFDC](/help/marketo/product-docs/core-marketo-concepts/smart-campaigns/salesforce-flow-actions/change-status-in-sfdc-campaign.md).
