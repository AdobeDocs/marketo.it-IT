...
Proprio come puoi [Aggiungi alla campagna SFDC](/help/marketo/product-docs/core-marketo-concepts/smart-campaigns/salesforce-flow-actions/add-to-sfdc-campaign.md) e [Cambia stato nella campagna SFDC](/help/marketo/product-docs/core-marketo-concepts/smart-campaigns/salesforce-flow-actions/change-status-in-sfdc-campaign.md), è inoltre possibile rimuovere persone o lead da una campagna Salesforce.
