...
# Utilizzare una durata in un passaggio di flusso di attesa {#use-a-duration-in-a-wait-flow-step}
...
1. Facoltativamente, specifica l’ora. Fai clic su **[!UICONTROL Save]**.
