...
description: Scopri come cancellare i valori dei campi in un passaggio di flusso di Smart Campaign. Rimuovere i valori dai campi della persona o dell'azienda.
...
1. Al termine del passaggio del flusso, il valore del campo scelto viene cancellato.
   ...
   >[!CAUTION]
   >
   >Se si lascia vuoto il nuovo valore o si immette uno SPAZIO, il campo non verrà effettivamente vuoto. È necessario digitare NULL. Inoltre, ricorda che i passaggi di flusso non possono essere annullati dopo l’esecuzione.
