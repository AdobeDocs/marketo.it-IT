...
# Tipi di voci di visualizzazione programmati del programma {#program-schedule-view-entry-types}

Sono disponibili otto tipi di voci integrate che saranno visibili e utilizzabili nella visualizzazione programmazione del programma. Puoi anche [creare tipi](create-custom-entry-types.md) di voci personalizzati nella sezione Amministratore.
