...
1. Fai clic su **Azioni del programma**. Fai clic su **Elimina**.
...
>[!TIP]
>
>**Programmi di archiviazione** mantiene i dati del programma, ma lo rende impossibile. Seleziona questa opzione e fai clic su **Successivo** per ulteriori informazioni sull&#39;archiviazione.
...
1. Fai clic su **Utilizzato da** per vedere dove viene utilizzata la risorsa.
