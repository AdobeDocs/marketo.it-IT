...
description: Informazioni sull'iscrizione al programma - Documenti Marketo - Documentazione prodotto
...
>[!NOTE]
>
>Una persona non può tornare indietro a uno stato precedente del programma. La progressione dello stato è solo un modo.

## Stati di successo {#success-statuses}

Lo scopo di un programma è quello di creare un&#39;interazione significativa con la persona o il potenziale. Il successo è indicato quando una persona raggiunge lo stato che raggiunge tale obiettivo.
...
>[!MORELIKETHIS]
>
>* [Utilizzo dei tag in un programma](/help/marketo/product-docs/core-marketo-concepts/programs/working-with-programs/understanding-tags/use-tags-in-a-program.md)
