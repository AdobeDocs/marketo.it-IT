...
Oltre a My Tokens, puoi anche utilizzare uno qualsiasi dei token incorporati nei tuoi programmi. Controlla la panoramica [dei](/help/marketo/product-docs/demand-generation/landing-pages/personalizing-landing-pages/tokens-overview.md)token.
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td>Utilizzate questo token per <a href="../../../../product-docs/email-marketing/general/functions-in-the-editor/create-a-calendar-event-ics-file.md">aggiungere un file evento del calendario (.</a><a href="../../../../product-docs/email-marketing/general/functions-in-the-editor/create-a-calendar-event-ics-file.md">ics)</a> alle e-mail e alle pagine di destinazione.</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td>Utilizzate questo token per eseguire uno script Velocity nelle e-mail. Ulteriori informazioni <a href="http://developers.marketo.com/documentation/email-scripting/" title="Segui collegamento" rel="nofollow">sono disponibili qui</a>. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td>Utilizzate questo token nel passaggio <a href="../../../../product-docs/core-marketo-concepts/smart-campaigns/flow-actions/use-tokens-in-flow-steps.md">di flusso del punteggio di</a>modifica. </td> 
  </tr> 
  <tr> 
