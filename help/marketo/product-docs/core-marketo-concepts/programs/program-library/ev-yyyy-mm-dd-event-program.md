...
Questo è un esempio di un programma di eventi con una pagina di registrazione, tre e-mail di invito e messaggi e-mail di follow-up che utilizzano un programma di eventi di Marketo Engage. Adatto per tutti gli eventi per i quali è necessaria la registrazione, inclusi eventi itineranti, pranzi, cene o presentazioni durante le fiere. Utilizza l’app Eventi di Marketo Engage per il check-in e il tracciamento della partecipazione sul tuo iPad.
...
>[!NOTE]
>
>Prima dell’evento, scarica le informazioni di registrazione sul tuo iPad. Quindi archivia i visitatori e sincronizza le informazioni sulla partecipazione con il Marketo Engage. Se non si dispone di un tablet, è possibile [importa partecipanti](/help/marketo/product-docs/core-marketo-concepts/programs/working-with-programs/import-members-from-a-spreadsheet-into-a-program.md){target="_blank"} in seguito, nella scheda &quot;Membri&quot; del programma, prima di inviare le e-mail di follow-up.
