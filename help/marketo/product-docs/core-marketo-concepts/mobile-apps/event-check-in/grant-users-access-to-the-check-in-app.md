...
Il Marketo Engage ha un ruolo utente speciale per l&#39;app di archiviazione degli eventi. Ecco come creare un nuovo ruolo con l’autorizzazione per utilizzare l’app.
...
1. Fai clic sulla scheda **[!UICONTROL Ruoli]**, quindi fai clic su **[!UICONTROL Nuovo ruolo]**.

   ![](assets/image2015-6-2-11-3a3-3a23.png)

1. Immettere un nome per il nuovo ruolo e una descrizione facoltativa. Selezionare la casella **[!UICONTROL Accedi all&#39;applicazione mobile]** e fare clic su **[!UICONTROL Crea]**.
...
1. Immettere le informazioni del nuovo utente. Seleziona le caselle di controllo per tutti i ruoli appropriati e il nuovo ruolo con l’autorizzazione per accedere all’app mobile. Al termine, fai clic su **[!UICONTROL Invita]**.
