---
description: Scopri le icone nell’interfaccia utente di Marketo Engage Modern e come vengono mappate da Classic. Utilizza questo glossario per identificare i tipi di risorse, gli stati delle campagne e i tipi di programmi.
...
Di seguito sono riportate le icone per la nuova interfaccia Adobe Marketo Engage. Se devi fare riferimento alle icone di Marketo Classic, puoi trovarle [qui](/help/marketo/getting-started/things-to-know/classic-icon-glossary.md).
...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td>Programma coinvolgimento</td>
  </tr>
  <tr>
...
## Campagne di attivazione {#trigger-campaigns}
