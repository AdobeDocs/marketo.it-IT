...
description: Visualizza la classificazione del sito in base alle parole chiave nel tempo con il rapporto Keyword Rank Trends (Tendenze classificazione parole chiave).
...
1. Fai clic su **[!UICONTROL Keyword Rank Trends]**.
   ...
   **Elementi report**
   ...
   | [!UICONTROL Avg. searches] | Il numero medio di ricerche su tali parole chiave che si sono verificate durante l&#39;intervallo impostato (negli ultimi 30 giorni) nella ricerca Google US |
