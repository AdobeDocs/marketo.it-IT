...
description: Apri i risultati del motore di ricerca per una parola chiave in una nuova finestra per vedere come appare il contenuto nella ricerca.
...
Per visualizzare l’aspetto del contenuto all’interno di un motore di ricerca, è stata aggiunta una scorciatoia.
