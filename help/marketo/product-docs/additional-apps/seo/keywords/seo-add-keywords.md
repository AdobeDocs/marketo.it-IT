...
>[!NOTE]
>
>Se hai molte parole chiave, puoi [importarli con un file CSV](/help/marketo/product-docs/additional-apps/seo/keywords/seo-importing-keywords-with-a-csv.md).

1. Vai a **Parole chiave** sezione .

   ![](assets/image2014-9-18-11-3a28-3a39.png)

1. Inserisci le parole chiave di cui desideri eseguire il targeting e fai clic su **Salva**.
