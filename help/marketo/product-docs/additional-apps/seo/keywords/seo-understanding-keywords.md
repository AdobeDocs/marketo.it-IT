...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colspan="1" rowspan="1">Parola chiave a portata di mano.</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colspan="1" rowspan="1">La difficoltà di ottenere la classificazione per una parola chiave specifica. </td> 
  </tr> 
  <tr> 
   <td colspan="1" rowspan="1">Ricerche mensili</td> 
   <td colspan="1" rowspan="1">Quante ricerche si verificano al mese sulla parola chiave. Questi dati si basano su corrispondenze esatte ed è disponibile solo per Google-US su un periodo di 12 mesi. </td> 
  </tr> 
  <tr> 
   <td colspan="1" rowspan="1">URL di classificazione più alto per frase chiave</td> 
   <td colspan="1" rowspan="1">Degli URL, che è il più alto nella classifica per la parola chiave.</td> 
  </tr> 
 </tbody> 
</table>

## Parole chiave - Vista concorrenza {#keywords-competitor-view}
...
Fantastico! Ora che conosci la sezione relativa alle parole chiave, impariamo le pagine e i collegamenti in entrata.
