...
description: Ottieni suggerimenti Marketo per preziosi collegamenti in entrata per parola chiave per migliorare l’ottimizzazione fuori pagina.
...
1. Immettere una parola chiave. Fai clic su **[!UICONTROL Suggest Links]**.

   ![](assets/image2014-9-18-13-3a21-3a31.png)

1. Seleziona i collegamenti. Fai clic su **[!UICONTROL Add Selected]**.
