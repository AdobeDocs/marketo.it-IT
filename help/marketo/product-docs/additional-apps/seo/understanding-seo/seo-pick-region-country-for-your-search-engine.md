...
description: Imposta la regione o il paese per il motore di ricerca utilizzato per i dati di classificazione delle parole chiave.
...
1. Fai clic sulla scheda **[!UICONTROL Search engines]**.
