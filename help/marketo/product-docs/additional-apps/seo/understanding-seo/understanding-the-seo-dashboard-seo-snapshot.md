...
description: Utilizza il dashboard SEO per visualizzare le tendenze di classificazione delle parole chiave, il punteggio medio di ottimizzazione della pagina e il riepilogo di classificazione delle parole chiave per il tuo sito.
...
Consulta la sezione [!UICONTROL Recommendations] di questo dashboard.
