...
description: Scopri come rimuovere un problema di pagina dal tracciamento.
title: 'SEO: rimuovere/eliminare un problema della pagina'
...
# SEO: rimuovere/eliminare un problema della pagina {#seo-remove-delete-a-page-issue}
...
1. Nella sezione [!UICONTROL Pages], fare clic su **[!UICONTROL Issues]**.

   ![](assets/image2014-9-18-14-3a0-3a30.png)

1. Passa il puntatore del mouse sul problema della pagina da rimuovere. Fai clic su **[!UICONTROL Remove]**.

   ![](assets/image2014-9-18-14-3a0-3a38.png)

1. Facendo clic su **[!UICONTROL Delete]** si rimuoverà definitivamente il problema relativo alla pagina.
