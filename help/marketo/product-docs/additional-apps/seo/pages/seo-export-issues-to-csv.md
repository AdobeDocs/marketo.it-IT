...
1. Fare clic sulla pagina per la quale si desidera visualizzare i dettagli.
   ...
   Questo è il [approfondimento pagina](/help/marketo/product-docs/additional-apps/seo/pages/seo-using-the-page-detail-drill-down.md). **[!UICONTROL Page Optimization Results]** è un elenco di tutti i problemi relativi a quella particolare pagina.
