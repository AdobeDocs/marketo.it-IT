...
description: Esporta i problemi di ottimizzazione della pagina in un file CSV dal drill-down dei dettagli della pagina per condividerli al di fuori di Marketo.
title: 'SEO: esportare problemi in file CSV'
...
# SEO: esportare problemi in file CSV {#seo-export-issues-to-csv}

Scopri come esportare i dati del problema della pagina in un file CSV se intendi condividere tali informazioni con persone al di fuori di Marketo.
...
1. Fare clic sulla pagina per la quale si desidera visualizzare i dettagli.
   ...
   Viene visualizzata la finestra di approfondimento pagina. **[!UICONTROL Page Optimization Results]** è un elenco di tutti i problemi relativi a quella particolare pagina.
