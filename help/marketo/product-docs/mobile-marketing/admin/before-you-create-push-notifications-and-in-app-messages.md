...
description: Scopri cosa impostare prima di creare messaggi push e in-app. Ottieni i passaggi per l’amministratore e gli sviluppatori, SDK e le linee guida per gli eventi personalizzati.
...
>[!TIP]
>
>è facile per un amministratore di Marketo verificare se la configurazione push è verificata. Vai [qui](/help/marketo/product-docs/mobile-marketing/admin/verify-push-configuration.md).
