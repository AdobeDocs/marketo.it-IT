---
description: Scopri come aggiornare il campo Tipo di attività durante la registrazione delle attività in Salesforce. Aggiungere un tipo di risposta all'elenco a discesa Tipo di task in Installazione di Salesforce.
