...
1. Nella barra di navigazione a sinistra, in Genera, espandi (ma non fai clic su) Personalizza, quindi Lead. Quindi, seleziona **Layout di pagina**.
...
<table>
 ...
 <tr>
  <td>Aggiungi a campagna MSC (classica)</td>
  <td>Aggiungi a campagne MSC da Salesforce</td>
  <td>
  <p>Contatto
  <p>Lead</td>
