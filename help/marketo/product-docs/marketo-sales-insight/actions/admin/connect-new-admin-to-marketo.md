---
description: Scopri come collegare un nuovo amministratore a Marketo e trasferire l’integrazione Marketo. Segui i passaggi per disconnettere l’amministratore corrente e stabilire una nuova connessione.
