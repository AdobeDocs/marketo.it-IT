...
* Canale di consegna e-mail: Il team avrà la possibilità di utilizzare il canale di consegna Gmail/Outlook o di impostare un SMTP personalizzato. [Fai clic qui](/help/marketo/product-docs/marketo-sales-insight/actions/email/email-delivery/delivery-channel-overview.md) per saperne di più sulla selezione del canale di consegna adatto alle tue esigenze.
