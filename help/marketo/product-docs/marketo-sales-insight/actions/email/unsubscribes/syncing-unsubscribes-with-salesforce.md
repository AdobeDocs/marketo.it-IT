---
description: Scopri come sincronizzare gli annullamenti degli abbonamenti tra le azioni di Sales Insight e Salesforce. Mantenere lo stato di rinuncia coerente tra i sistemi.
...
1. Fai clic sulla scheda **[!UICONTROL Integrations]**. In [!UICONTROL Sync to Salesforce] abilitare la sincronizzazione notturna.
