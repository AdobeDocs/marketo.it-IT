...
description: Aggiornamento del componente aggiuntivo Marketo Email per Outlook - Documentazione di Marketo - Documentazione del prodotto
title: Aggiornamento del componente aggiuntivo e-mail per Marketo per Outlook
...
# Aggiornamento del componente aggiuntivo e-mail per Marketo per Outlook {#upgrade-your-marketo-email-add-in-for-outlook}

Quando è disponibile una nuova versione di Marketo Email Add-in per Outlook, attenersi alle istruzioni riportate di seguito per effettuare l&#39;aggiornamento.

>[!NOTE]
>
>A partire dal 10/1/20, la versione più recente del plug-in di Outlook non supporta più la modalità offline. Questa opzione avrà effetto dopo l’installazione o l’aggiornamento in data 10/1 o dopo.
...
&#42;Versione di Office 365: solo client Windows (su Windows 10, Enterprise o Pro).
...
1. Fai clic su **Avanti**.
   ...
   >[!NOTE]
   >
   >In alcuni casi i dati saranno mancanti. Copialo dall&#39;e-mail di registrazione, quindi chiudi Outlook.
...
1. Aprire Microsoft Outlook per visualizzare la versione più recente dei pulsanti di Marketo.
