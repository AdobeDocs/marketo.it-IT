...
1. Selezionare **Abilita API Marketo**. Quindi, compila le [informazioni di configurazione API in Marketing Admin](#set-up-marketo-sales-insight). Al termine, fare clic su **Salva modifiche**.
