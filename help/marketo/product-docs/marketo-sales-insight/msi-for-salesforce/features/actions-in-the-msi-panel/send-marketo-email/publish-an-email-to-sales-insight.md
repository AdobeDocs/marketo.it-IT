...
description: Scopri come pubblicare un’e-mail da Marketo a Sales Insight. Rendi un modello e-mail Marketo disponibile per gli utenti di vendita nel pannello MSI.
...
1. Per impostare una data di scadenza (facoltativa), selezionare **[!UICONTROL Set Expiration]** e scegliere una data.
   ...
   >[!NOTE]
   >
   >Alle 23:00 (ora legale del Pacifico) della data di scadenza (se impostata), l&#39;e-mail resa disponibile scompare da [!DNL Sales Insight] e dai relativi componenti aggiuntivi. :59Naturalmente sarà ancora accessibile in Marketo.
