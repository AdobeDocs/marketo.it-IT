...
Se il tuo account Marketo è connesso a Salesforce tramite un’integrazione personalizzata o non nativa, utilizza questo documento per configurare Sales Insight.

>[!PREREQUISITES]
>
>* La funzione &quot;MSI non nativa&quot; abilitata per la tua istanza Marketo prima di iniziare a configurare MSI (se non lo è e hai già acquistato la funzione, contatta il [Supporto Marketo](https://nation.marketo.com/t5/support/ct-p/Support) - se non hai ancora acquistato questa funzione, contatta il tuo Customer Success Manager).
...
>* Configurazione dell&#39;API REST di Marketo [completata](https://developers.marketo.com/rest-api/). Le API CRUD esposte costituiranno la base per l’esecuzione della sincronizzazione non nativa.
...
1. Sincronizza con Marketo l&#39;utente di vendita Salesforce.
   ...
   L&#39;Utente Vendite Salesforce è un utente esterno proprietario dei Lead/Contatti di Salesforce. Un venditore Marketo deve essere aggiornato per l&#39;utente di vendita Salesforce. Il campo *externalSalesPersonId* è obbligatorio per l&#39;upsert del venditore.
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td><p>Identifica il record Marketo Sales Person in un oggetto Salesforce Sales User esterno.</p><p>Viene richiesto di sincronizzare prima la persona di vendita prima di sincronizzare gli altri oggetti in modo che vengano create le relazioni corrette.</p></td> 
  </tr> 
 </tbody> 
</table>
...
1. Sincronizza i campi del punteggio MSI/Momento ultimo interessante all’SFDC.
   ...
   I campi Ultimo momento interessante/Punteggio di un lead Marketo devono essere regolarmente sincronizzati con Salesforce utilizzando l’endpoint REST API Lead. Eseguire una query sull&#39;endpoint per un lead Marketo utilizzando _externalPersonId_ come filtroType e passare il GUID lead Salesforce come filtroValue.
