...
Passaggio 2: Il dipendente della tua organizzazione che lavora con la nostra API può quindi iniziare l’implementazione. Ulteriori informazioni sono disponibili qui: [API per attività personalizzata](https://developers.marketo.com/documentation/rest/add-custom-activities/)
