...
description: Scopri i campi gestiti dal sistema non modificabili nella pagina dei dettagli della persona e cosa significa ogni tipo di campo.
...
<tbody>
  ...
  <tr>
    <td>Contatto</td>
    <td>La persona è stata sincronizzata da Salesforce come contatto</td>
  </tr>
  <tr>
    <td>API MUNCHKIN</td>
