...
>[!TIP]
>
>Potete personalizzare la posizione dell&#39;HTML non iscritto nel messaggio e-mail utilizzando [token](../../../product-docs/email-marketing/general/using-tokens/add-a-system-token-as-a-link-in-an-email.md).
