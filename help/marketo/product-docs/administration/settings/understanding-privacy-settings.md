...
* Per [!DNL Munchkin], aggiungere `{"anonymizeIP",true}` alla funzione [init](https://experienceleague.adobe.com/it/docs/marketo-developer/marketo/javascriptapi/leadtracking/configuration){target="_blank"}.
