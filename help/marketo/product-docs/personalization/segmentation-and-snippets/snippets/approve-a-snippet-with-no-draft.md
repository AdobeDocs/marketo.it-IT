...
1. Nel menu a discesa **[!UICONTROL Snippet actions]**, scegli **[!UICONTROL Approve draft]**.

   ![](assets/approve-the-snippet-3.png)

1. Selezionare un&#39;opzione nella finestra di dialogo Approva frammento e fare clic su **[!UICONTROL Approve]**:

   * **[!UICONTROL Update all]**: questa opzione non crea bozze delle risorse approvate utilizzando lo snippet. Tutte le risorse ricevono gli aggiornamenti e mantengono gli stati precedenti. Un modulo di avanzamento viene visualizzato sul lato destro superiore dello schermo e può essere chiuso in qualsiasi momento. Per ripristinarlo, fare clic con il pulsante destro del mouse sul nome del frammento e selezionare Mostra stato approvazione.
   * **[!UICONTROL Create drafts]**: con questa opzione verranno create bozze delle risorse approvate utilizzando lo snippet. Selezionare questa opzione se è necessario rivedere prima le modifiche apportate al frammento. Tutte le bozze devono essere approvate manualmente
