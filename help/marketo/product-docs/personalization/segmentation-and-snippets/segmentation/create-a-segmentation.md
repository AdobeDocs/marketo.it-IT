...
1. Fare clic su **New **e quindi su **New Segmentation**.
...
1. Trascinate e rilasciate i segmenti per modificarne l’ordine. Al termine, fare clic su **Crea**.
   ...
   >[!NOTE]
   >
   >Una persona sarà qualificata per il primo segmento corrispondente nel [order](segmentation-order-priority.md) definito.
