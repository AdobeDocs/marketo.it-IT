...
description: Scopri come impostare la mappatura dell’organizzazione Adobe in Marketo Engage per la sincronizzazione con Audience Manager e altre app Adobe.
...
1. Immetti il [ID organizzazione Adobe IMS](https://experienceleague.adobe.com/docs/control-panel/using/faq.html?lang=it){target="_blank"}) e fai clic su **[!UICONTROL OK]**.
