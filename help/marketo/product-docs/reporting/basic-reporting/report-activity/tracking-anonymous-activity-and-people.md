...
1. Un&#39;attività anonima viene creata quando un utente:
   ...
   * Utilizza l&#39;API [REST API](https://experienceleague.adobe.com/it/docs/marketo-developer/marketo/rest/lead-database/leads) o [Munchkin](https://experienceleague.adobe.com/en/docs/marketo-developer/marketo/javascriptapi/lead-tracking) di Marketo (per sviluppatori) per associare un&#39;attività anonima a un record noto.
