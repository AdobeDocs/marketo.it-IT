---
description: Scopri Advanced BI Analytics, un’interfaccia di reporting flessibile con visualizzazioni avanzate e prestazioni più veloci per i dati Marketo Engage. Crea rapporti personalizzati con dashboard interattivi e opzioni di esportazione.
...
# Panoramica di Analisi BI avanzata {#advanced-bi-analytics-overview}
...
1. Nella pagina Rapporti, fai clic sull’icona Altro (...) del report desiderato e selezionare **Esporta**.
...
>[!VIDEO](https://video.tv.adobe.com/v/3451690/?captions=ita&quality=12&learn=on){transcript=true}
