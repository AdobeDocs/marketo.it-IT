...
# Creare un rapporto di analisi e-mail che mostri le informazioni sul programma {#build-an-email-analysis-report-that-shows-program-information}
...
1. Selezionate** Area Analisi e-mail** e fate clic su **OK**.

   ![](assets/image2014-9-17-19-3a43-3a20.png)

1. Trova il punto giallo **inviato (settimana)** e fai clic con il pulsante destro del mouse. Fate clic su **Filtro**.
...
1. Selezionare Settimana **** corrente inviata e fare clic su **OK**.
...
1. Trova e fai doppio clic sui punti blu **Inviati**, **Aperti** e **Cliccati** .
   ...
   >
   >
   >Vuoi saperne di più su [Revenue Cycle Explorer](http://docs.marketo.com/display/docs/revenue+cycle+analytics)?
