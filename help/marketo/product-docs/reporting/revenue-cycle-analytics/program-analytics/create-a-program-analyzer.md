...
description: Scopri come creare un analizzatore di programmi in Marketo Engage utilizzando create-a-program-analyzer. Utilizza questa guida per completare il passaggio successivo.
