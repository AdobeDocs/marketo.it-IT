...
description: Scopri l’esempio di attribuzione 2 in Marketo Engage, incluso l’esempio di attribuzione 2. Utilizza questa guida per completare il passaggio successivo.
...
* Aprile 25 | Bill e Joan sono associati a ruoli di **BOTH** Optys
