...
Scegliendo i valori dei tag della pagina (og:title, og:caption e og:description), la miniatura viene aggiunta automaticamente ai post di Facebook. Vedere il passaggio successivo.
