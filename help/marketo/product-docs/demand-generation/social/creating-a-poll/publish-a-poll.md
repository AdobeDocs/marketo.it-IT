...
Dopo aver [creato un sondaggio](/help/marketo/product-docs/demand-generation/social/creating-a-poll/create-a-poll.md), puoi pubblicarlo nelle pagine di destinazione di Marketo, su Facebook e sul sito Web.
