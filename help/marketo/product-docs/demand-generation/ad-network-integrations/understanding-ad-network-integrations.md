...
# Informazioni sulle integrazioni di rete di annunci {#understanding-ad-network-integrations}
...
* Invio di audience a sistemi multimediali a pagamento al fine di indirizzare i clienti a potenziali clienti con annunci display personalizzati per fiorire o riattivarli

   * Segmento per fase acquirente, livello di coinvolgimento e altro
   * Espandi il pubblico per migliorare l&#39;acquisizione
   * Destinazione di abbonamenti e non-mail con annunci
   * Cultura tra canali, ad esempio e-mail e annunci digitali

* Inserimento di lead o dati da sistemi di media a pagamento in Marketo

   * Ad esempio, un utente di Facebook fa clic su un pulsante Iscrizione e fornisce un nome e un indirizzo e-mail

* Caricamento dei dati di conversione offline nei sistemi multimediali a pagamento, ottimizzazione dell’acquisizione lead e sforzi di sviluppo
