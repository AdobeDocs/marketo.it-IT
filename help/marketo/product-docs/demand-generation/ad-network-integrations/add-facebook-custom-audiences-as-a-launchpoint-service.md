...
1. Immettete un nome **** visualizzato per il servizio e selezionate il servizio Pubblico **personalizzato di** Facebook dal menu a discesa **Servizio** .
...
1. Aprite una nuova scheda nello stesso browser e andate a [www.facebook.com.](http://www.facebook.com./) Effettuate l&#39;accesso a Facebook utilizzando l&#39;account che desiderate utilizzare per l&#39;integrazione.
   ...
   >[!CAUTION]
   >
   >Affinché Marketo possa inviare audience tra più account Ad Manager, l&#39;utente Facebook che autorizzi nei seguenti passaggi deve avere accesso a *tutti* questi account.

   ![](assets/image2016-11-29-10-3a52-3a29.png)

1. Dopo aver effettuato l&#39;accesso a Facebook, tornate a Marketo. Fate clic su **Autorizza**.

   ![](assets/fb-custom-authorize-hand.png)

   >[!NOTE]
   >
   >Per consentire il corretto funzionamento dell&#39;integrazione dell&#39;audience personalizzata, *dovete* utilizzare un account Facebook Business Manager. Per informazioni su come impostare un account Business Manager, consultare la Guida [di](https://www.facebook.com/business/help/1710077379203657)Facebook.

1. Se richiesto, fate clic su **OK **per accettare l&#39;installazione dell&#39;app Marketo in Facebook.

   ![](assets/image2016-11-29-10-3a56-3a3.png)

1. Adesso sei autorizzato! Selezionate una modalità corrispondente e fate clic su **Crea**.

   >[!NOTE]
   >
   >**Base Matching** usa solo indirizzi e-mail.**Advanced Matching** utilizza sette campi aggiuntivi, che aumentano il tasso di corrispondenza, per una maggiore conversione. Tuttavia, se l&#39;informativa sulla privacy dell&#39;azienda non consente la condivisione di campi aggiuntivi o se i dati non li includono, selezionare Corrispondenza di base.
