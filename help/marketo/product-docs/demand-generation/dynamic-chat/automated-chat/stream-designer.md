---
description: Scopri Stream Designer e le schede per la creazione di conversazioni chat. Aggiungere messaggi, domande, acquisizione di documenti, prenotazione di riunioni e altro ancora alle finestre di dialogo.
...
1. Quando si è pronti ad attivare la finestra di dialogo, fare clic su **[!UICONTROL Publish]**.
