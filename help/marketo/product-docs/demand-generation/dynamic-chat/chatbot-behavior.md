---
description: Scopri il comportamento dei chatbot in Dynamic Chat per finestre di dialogo, priorità e visitatori. Utilizza questo riferimento per comprendere il comportamento del chatbot in scenari diversi.
