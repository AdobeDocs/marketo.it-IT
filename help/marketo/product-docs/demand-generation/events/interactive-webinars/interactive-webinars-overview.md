...
Dopo il webinar, accedi a [event performance analytics](/help/marketo/product-docs/demand-generation/events/interactive-webinars/event-workflows.md){target="_blank"} tramite report e dashboard contenenti dati di coinvolgimento di lead e aggregati. I filtri e i trigger specifici per i webinar interattivi consentono di trovare gruppi specifici di persone che hanno intrapreso azioni specifiche (ad esempio, hanno fatto clic su un collegamento, scaricato una risorsa e altro).

## Domande frequenti {#faq}

**È necessaria una sottoscrizione separata per utilizzare i webinar interattivi?**
...
**Ho esaurito il numero di webinar interattivi inclusi. Come è possibile ottenere più sessioni o più capacità?**
...
**È necessario associare nuovamente il webinar con tecnologia Adobe Connect al programma di eventi del webinar interattivo, ad esempio ai programmi di eventi Launchpoint?**

No, i programmi di eventi di webinar interattivi creano l’associazione per te.

**Perché alcuni lead hanno uno stato di &quot;Errore di registrazione&quot; invece di &quot;Registrato?&quot;**
...
**Si verificano problemi audio/video durante la presentazione di un webinar durante l&#39;accesso alla VPN della mia organizzazione. Cosa posso fare?**
...
Non lo sono. Dopo l&#39;inizio del webinar, fare clic sull&#39;elenco a discesa accanto al nome del webinar e selezionare **Registra sessione**.
