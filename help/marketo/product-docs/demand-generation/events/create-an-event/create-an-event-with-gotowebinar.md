...
Dopo aver creato un evento Marketo e associato il GoToWebinar, i sistemi saranno in grado di condividere le informazioni di registrazione e partecipazione. Per informazioni sulla creazione di un GoToWebinar, consultate la Guida utente di [GoToWebinar](http://docs.marketo.com/display/docs/assets/gotowebinar-user-guide.pdf).
...
`Enter the following information for your webinar and it will be pulled into Marketo via the`adattatore. Se apporti modifiche a queste informazioni, devi fare clic sul collegamento &quot;**Aggiorna da provider** webinar&quot; in Azioni **** evento, per consentire a Marketo di vedere le modifiche.

**Data** di inizio: specifica la data di inizio. Questo sarà visibile in Marketo.

**Ora** di inizio - specifica l&#39;ora di inizio. Questo sarà visibile in Marketo.

**Ora** fine - immetti l&#39;ora di fine. Questo sarà visibile in Marketo.
...
>[!TIP]
>
>In GoToWebinar sono disponibili altri campi che NON influiscono sull’integrazione. Per ulteriori informazioni su tali campi, consultate la Guida [utente](http://docs.marketo.com/display/docs/assets/gotowebinar-user-guide.pdf) GoToWebinar, in quanto non saranno trattati in questo articolo. Se avete bisogno di ulteriore aiuto per GoToWebinar, visitate il sito [della](http://support.logmeininc.com/gotowebinar)guida.
...
1. Scegliete **VaiAwebinar** dall’elenco **dei** partner **dell’evento** .
