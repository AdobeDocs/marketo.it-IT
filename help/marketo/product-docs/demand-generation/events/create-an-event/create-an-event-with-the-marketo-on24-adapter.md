...
description: Scopri come creare un evento con l’adattatore Marketo ON24. Collega i webinar ON24 a Marketo e sincronizza la registrazione e la partecipazione.
...
* **Diritti di amministratore per ON24** - Sarà necessario utilizzare questo connettore per creare guest nel sistema ON24.
...
1. [Creare campagne secondarie e risorse in locale](/help/marketo/product-docs/demand-generation/events/create-an-event/create-an-event-with-the-marketo-on24-adapter/create-child-campaigns-and-local-assets.md){target="_blank"}
1. [Testare l’integrazione di un evento ON24](/help/marketo/product-docs/demand-generation/events/create-an-event/create-an-event-with-the-marketo-on24-adapter/test-your-on24-event-integration.md){target="_blank"}
...
1. [Informazioni sullo stato dei programmi per webinar](/help/marketo/product-docs/demand-generation/events/create-an-event/create-an-event-with-the-marketo-on24-adapter/understanding-webinar-program-statuses.md){target="_blank"}
1. [Aggiornamenti alla registrazione di un evento ON24](/help/marketo/product-docs/demand-generation/events/create-an-event/create-an-event-with-the-marketo-on24-adapter/on24-event-registration-updates.md){target="_blank"}
