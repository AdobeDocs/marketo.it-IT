...
>[!TIP]
>
>L’utilizzo di convenzioni di denominazione chiare semplifica l’utilizzo del modello da parte del team di marketing.
...
Esempio: `<div class="mktoText" id="exampleText" mktoName="Main Body Text"> Optionally add default text for the editable text area.</div>`
...
Esempio: `<div class="mktoImg" id="exampleImg" mktoName="Example Image"></div>`
...
Esempio: `<img class="mktoImg" id="exampleImg" mktoName="Example Image">`
...
Esempio: `<div class="mktoForm" id="exampleForm" mktoName="Example Form"></div>`
...
Esempio: `<div class="mktoSnippet" id="exampleSnippet" mktoName="Example Snippet"></div>`
...
Esempio: `<div class="mktoShareButton" id="exampleShareButton" mktoName="Example Share Button"></div>`
...
Esempio: `<div class="mktoVideo" id="exampleVideo" mktoName="Example Video"></div>`
...
Esempio di base: `<meta class="mktoString" id="var1" mktoName="My Variable">`

Esempio con tutti gli attributi: `<meta class="mktoString" id="var1" mktoName="My Variable" default="This is my default value" allowHtml="true">`
...
Esempio di base: `<meta class="mktoColor" id="color1" mktoName="My Color Variable">`

Esempio con tutti gli attributi: `<meta class="mktoColor" id="color" mktoName="My Color Variable" default="#336699">`
...
Esempio di base: `<meta class="mktoBoolean" id="boolean1" mktoName="My Boolean Variable">`

Esempio con tutti gli attributi: `<meta class="mktoBoolean" id="boolean1" mktoName="My Boolean Variable" default="false" true_value="block" false_value="none" true_value_name="Show" false_value_name="Hide">`

L’esempio seguente mostra un caso d’uso comune in cui una variabile booleana controlla la visibilità di un elemento css impostando il valore della proprietà di visualizzazione css su &quot;block&quot; o &quot;none&quot; per mostrare/nascondere un elemento per id con gli stili CSS. L’editor della pagina di destinazione utilizza il nome visualizzato Mostra/Nascondi invece di OFF/ON.
